...
public class NexusArtifactClient {
	 ...
	 */
	public NexusArtifactClient(String nexusRepoHost, String nexusRepoPort,
			String nexusRepoHttpScheme, String nexusArtifactRepo) {
		...
		if (repositoryLocation.getUsername() != null && repositoryLocation.getPassword() != null) {
			...
			credsProvider.setCredentials(new AuthScope(httpHost), new UsernamePasswordCredentials(repositoryLocation.getUsername(), repositoryLocation.getPassword()));
	 ...
	 */
	public UploadArtifactInfo uploadArtifact(String groupId, String artifactId, String version, String packaging, long contentLength, InputStream inputStream) throws ConnectionException {
	 ...
	 *  
	 * @param artifactReference : Artifact path to be deleted
	 * @throws Exception
	 */
