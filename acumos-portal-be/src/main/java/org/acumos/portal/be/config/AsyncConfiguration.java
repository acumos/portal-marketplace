...
public class AsyncConfiguration implements AsyncConfigurer {
    ...
    private final ConcurrencyProperties applicationProperties;

    public AsyncConfiguration(final ConcurrencyProperties applicationProperties) {
    ...
    private Executor newTaskExecutor(final String taskExecutorNamePrefix) {
        final ConcurrencyProperties.Async asyncProperties = applicationProperties.getAsync();
