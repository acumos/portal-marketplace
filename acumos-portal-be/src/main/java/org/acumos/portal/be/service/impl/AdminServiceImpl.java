...
public class AdminServiceImpl extends AbstractServiceImpl implements AdminService {
	...
	@Override
	public List<MLPeerSubscription> getPeerSubscriptions(String peerId) throws IOException, AcumosServiceException {
	...
	@Override
	public MLPeerSubscription getPeerSubscription(Long subId) throws IOException, AcumosServiceException {
