...
public class SiteContentServiceController extends AbstractController {
    ...
    public SiteContentServiceController() {}
    ...
    @RequestMapping(value = { APINames.UPDATE_CAROUSEL_PICTURE }, method = RequestMethod.POST, produces = APPLICATION_JSON)
    @ResponseBody
    ...
    @RequestMapping(value = { APINames.DELETE_CAROUSEL_PICTURE }, method = RequestMethod.DELETE, produces = APPLICATION_JSON)
    @ResponseBody
