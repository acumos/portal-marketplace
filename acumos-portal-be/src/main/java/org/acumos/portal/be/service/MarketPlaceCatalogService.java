...
public interface MarketPlaceCatalogService {
	...
	List<Author> addSolutionRevisionAuthors(String solutionId, String revisionId, Author author);

	List<Author> removeSolutionRevisionAuthors(String solutionId, String revisionId, Author author);
