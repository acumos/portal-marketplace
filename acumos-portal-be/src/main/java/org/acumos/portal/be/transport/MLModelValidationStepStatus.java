...
public class MLModelValidationStepStatus {

	private String validationType;
	private String validationStatus;
	private String validationStatusDesc;
	
	public MLModelValidationStepStatus() {
	...
	/**
	 * @return the validationStatusDesc
	 */
	...
	/**
	 * @param validationStatusDesc the validationStatusDesc to set
	 */
