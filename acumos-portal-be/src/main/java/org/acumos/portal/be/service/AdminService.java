...
public interface AdminService {
    ...
    List<MLPeerSubscription> getPeerSubscriptions(String peerId) throws IOException, AcumosServiceException;  

	MLPeerSubscription getPeerSubscription(Long subId) throws IOException, AcumosServiceException;
