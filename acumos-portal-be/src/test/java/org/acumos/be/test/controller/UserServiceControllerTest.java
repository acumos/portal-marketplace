...
//		userService.updateBulkUsers(mlpUser);
	...
	public void getUserImageTest() throws Exception{
	    ...
	    userServiceController.updateUserImage(request, file, userId, response);
	}
	...
	public void getQandAurlTest() throws Exception {
		...
		userServiceController.getQandAurl(request, response);
	}
	...
	public void getDocurl() throws Exception {
		userServiceController.getDocurl(request, response);
	}
	...
	public void getAllActiveUsers() throws Exception {
		...
		user.setPassword("password");
		users.add(user);
		userServiceController.getAllActiveUsers(request, response, activeFlag);
