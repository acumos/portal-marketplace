				...
				'modelEdit',
				{
					...
					controller : function($scope, $location, $http,
						...
						$scope.updateSolutionFiles = function() {
							...
							alert("Solution Id : " + $scope.solutionId + " # RevisionId : " + $scope.revisionId);
		                       	 ...
		                       	 $http(getSolutionDocumentsReq)
										.success(
												function(data, status, headers,
													...
													// $scope.docURLdefault =
													// "/site/binaries/content/assets/solutiondocs/solution/"+$scope.solutionId+"/"+data[0];
												}).error(
														function(data, status, headers,
																config) {
		                       	 ...
		                       	 $http(removeSolutionDocumentsReq)
										.success(
												function(data, status, headers,
													...
													/*
													 * if(data.response_body.length >
													 * 0)
													 * $scope.showPublicSolutionDocs =
													 * true;
													 * $scope.supportingPublicDocs =
													 * data.response_body;
													 */
