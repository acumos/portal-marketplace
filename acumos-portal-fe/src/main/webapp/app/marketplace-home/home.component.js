												      ...
												      if(slideObj.slideEnabled === true || slideObj.slideEnabled === "true"){
													      var bannerSt = '<div class='; 
														    ...
														    '<div class="slide-content">' +
								                             ...
								                             bannerSt = bannerSt + '</div> <div class="image-container" style="margin: 0 17px 0 17px; float: right; width: 35%;"><img ng-show="' + slideObj.graphicImgEnabled + '" src="/api/site/content/carouselImages/' + slideObj.infoImgKey + '" alt="" title="" '
