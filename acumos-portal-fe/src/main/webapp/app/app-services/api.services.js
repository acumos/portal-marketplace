...
angular.module('AcumosApp')
    .service('apiService', ['$http', function ($http, $window) {
        ...
        var urlTermsCondition = '/api/api-manual/solution/global/termsCondition';
        ...
        var urlCobrandLogoUrl = "/api/api-manual/solution/global/coBrandLogo";
        var urlCarouselPictureUrl = "/api/api-manual/solution/carouselImages";
        ...
        this.getCarouselPicture = function(key) {
        	return $http.get(urlCarouselPictureUrl + "/" + key);
        };
