angular.module('AcumosApp')
    .service('apiService', ['$http', function ($http) {
        ...
        var urlAuthAndDeployToAzure='http://localhost:9081/azure/authAndpushimage';
        ...
        this.getGithubAccessToken = function(code) {
        	return $http.get("https://api.github.com/user?access_token=" + code);
        };
        
        this.getGithubUserProfile = function(accessToken) {
        	return $http.get("https://api.github.com/user?access_token=" + accessToken);
        };
