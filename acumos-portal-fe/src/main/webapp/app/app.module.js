...
var app = angular.module('AcumosApp', ['ui.router','ngMaterial', 'ngMdIcons','satellizer',
                                        ...
                                        'marketFooter','notificationModule', 'termsCondition', 'ui.carousel','admin','503Error',
                                        '404Error','ngDragDrop','naif.base64','confirmVerification', 'publishRequest'/*'socialLogin'*/]);
